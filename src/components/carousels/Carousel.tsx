      ...
      >
        {carouselItems.map((item) => (
          ...
          >
            ...
            <div className="relative z-10 container w-11/12   max-width-screen mx-auto h-full flex flex-col justify-center items-center md:items-start text-center md:text-left">
